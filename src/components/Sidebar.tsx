        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="relative w-full max-w-md bg-white rounded-2xl p-6 shadow-2xl border border-slate-200 space-y-5">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div>
                <h3 className="font-bold text-slate-900 text-base">Chuyển Đổi Vai Trò & Tài Khoản</h3>
                <p className="text-xs text-slate-500">Chọn vai trò hoặc tài khoản mẫu để trải nghiệm</p>
              </div>
              <button
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  ...
                  <div className="text-xs">Chủ Nhà</div>
                </button>

                <button
                  onClick={() => {
                    switchRoleQuick('tenant');
                    setIsRoleModalOpen(false);
                  }}
                  className={`p-3 rounded-xl border text-center transition-all ${
                ...
                >
                  ...
                  <div className="text-xs">Khách Thuê</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs">Quản Trị</div>
                </button>
              </div>
            </div>

            {/* Individual Demo User Profiles List */}
            <div className="space-y-2">
              <div className="text-xs font-bold text-slate-700 uppercase tracking-wider">
                Hoặc chọn tài khoản cụ thể:
              </div>
              <div className="max-h-48 overflow-y-auto space-y-1.5 pr-1">
                {users.map((u) => (
                  ...
                  >
                    ...
                    {u.id === currentUser.id && <Check className="w-4 h-4 text-emerald-600" />}
                  </button>
                ))}
              </div>
            </div>

            {/* Actions: Logout and Reset Data Option */}
            <div className="pt-2 border-t border-slate-100 flex flex-col gap-1.5">
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs text-slate-700 hover:bg-slate-100 font-semibold transition-colors border border-slate-200"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 py-1.5 rounded-xl text-[11px] text-rose-600 hover:bg-rose-50 font-medium transition-colors"
              >
